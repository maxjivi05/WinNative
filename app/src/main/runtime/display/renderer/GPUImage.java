...
public class GPUImage extends Texture {
    ...
    /**
     * Raw {@code AHardwareBuffer*} for the Direct Composition path, which hands the
     * buffer to an {@code ASurfaceControl} instead of sampling it in the compositor.
     * Returns 0 once destroyed; callers must treat 0 as "fall back to normal compositing".
     */
