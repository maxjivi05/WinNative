...
class GOGService : Service() {
    ...
    companion object {
        ...
        fun getGogWineStartCommand(
            ...
            envVars: com.winlator.cmod.core.EnvVars,
            guestProgramLauncherComponent: com.winlator.cmod.xenvironment.components.GuestProgramLauncherComponent,
            gameId: Int,
        ): String {
        ...
        fun downloadGame(context: Context, gameId: String, installPath: String, containerLanguage: String): Result<DownloadInfo?> {
            val activeInstance = getInstance() ?: run {
                start(context)
