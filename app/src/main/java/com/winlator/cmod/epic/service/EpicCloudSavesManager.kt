...
import com.winlator.cmod.epic.service.manifest.EpicManifest
...
object EpicCloudSavesManager {
    ...
    private suspend fun determineSyncAction(
        context: Context,
        accountId: String,
        game: com.winlator.cmod.epic.data.EpicGame,
    ...
    private fun packageSaveFiles(
        ...
        try {
            ...
            val chunks = mutableListOf<com.winlator.cmod.epic.service.manifest.ChunkInfo>()
            val fileManifests = mutableListOf<com.winlator.cmod.epic.service.manifest.FileManifest>()
            ...
            files.forEach { file ->
                try {
                    ...
                    val fileManifest = com.winlator.cmod.epic.service.manifest.FileManifest()
                    ...
                    while (fileOffset < fileData.size) {
                        ...
                        val chunkPart = com.winlator.cmod.epic.service.manifest.ChunkPart(
    ...
    private fun finalizeChunk(
    ...
    ): com.winlator.cmod.epic.service.manifest.ChunkInfo {
        ...
        val chunkInfo = com.winlator.cmod.epic.service.manifest.ChunkInfo()
        chunkInfo.guid = guid
    ...
    private fun createManifest(
        game: EpicGame,
        accountId: String,
        chunks: List<com.winlator.cmod.epic.service.manifest.ChunkInfo>,
        fileManifests: List<com.winlator.cmod.epic.service.manifest.FileManifest>,
    ): com.winlator.cmod.epic.service.manifest.EpicManifest {
        val manifest = com.winlator.cmod.epic.service.manifest.BinaryManifest()

        // Meta
        manifest.meta = com.winlator.cmod.epic.service.manifest.ManifestMeta()
        ...
        // Custom fields
        manifest.customFields = com.winlator.cmod.epic.service.manifest.CustomFields()
        manifest.customFields!!["CloudSaveFolder"] = game.saveFolder

        // Chunks
        manifest.chunkDataList = com.winlator.cmod.epic.service.manifest.ChunkDataList()
        manifest.chunkDataList!!.elements.addAll(chunks)

        // Files
        manifest.fileManifestList = com.winlator.cmod.epic.service.manifest.FileManifestList()
