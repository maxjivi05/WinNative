            ...
            setContent {
                WinNativeTheme(
                    ...
                    StoresScreen(
                        ...
                        onPickBattleNetFolder = { pickFolder(PrefManager.battleNetDownloadFolder) { PrefManager.battleNetDownloadFolder = it } },
    ...
    private fun refresh() {
        ...
        storeState =
            StoreState(
                ...
                battleNetFolder = resolveUri(PrefManager.battleNetDownloadFolder, ctx),
